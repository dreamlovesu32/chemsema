...
hand-compute benzene, cyclopentane, or fused-ring coordinates when ChemSema can
...
Use ChemSema defaults unless the user asks for a specific style:
...
document, copy visible font family, size, bold, italic, and color where ChemSema
stores them.
