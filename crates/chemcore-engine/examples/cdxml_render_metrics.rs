use chemcore_engine::{parse_cdxml_document, render_document, Point, RenderPrimitive};
    ...
    for primitive in &primitives {
        match primitive {
            RenderPrimitive::Polygon {
                ...
                bond_id: Some(_),
                ..
            } if *role == chemcore_engine::RenderRole::DocumentBond => {
            ...
            RenderPrimitive::Path {
                ...
                ..
            } if *role == chemcore_engine::RenderRole::DocumentGraphic
