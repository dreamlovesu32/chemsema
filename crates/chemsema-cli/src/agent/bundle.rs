...
const BUNDLE_SCHEMA: &str = "chemsema.agent.bundle.v1";
const IDENTITY_MAP_SCHEMA: &str = "chemsema.identity-map.v1";
const PROVENANCE_SCHEMA: &str = "chemsema.agent.provenance.v1";
...
fn referential_integrity(document: &ChemSemaDocument) -> ReferentialIntegrity {
...
fn identity_map_for_documents(
    source: &ChemSemaDocument,
    subset: &ChemSemaDocument,
...
fn document_selector_kinds(document: &ChemSemaDocument) -> BTreeMap<String, String> {
...
fn provenance_for_bundle(
    engine: &Engine,
    source_document: &ChemSemaDocument,
    subset: &ChemSemaDocument,
    options: &BundleOptions,
    target_bounds: [f64; 4],
    visual_bounds: [f64; 4],
...
fn subset_translation_from_export_meta(subset: &ChemSemaDocument) -> Value {
...
fn editable_scope_json(document: &ChemSemaDocument) -> Value {
