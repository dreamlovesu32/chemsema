...
use crate::{refresh_repeating_units, ChemSemaDocument, Point, SceneObject, SelectionState};
...
fn objects_are_linked(document: &ChemSemaDocument, bracket_id: &str, text_id: &str) -> bool {
