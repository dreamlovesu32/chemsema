...
pub fn anchor_from_point(document: &ChemSemaDocument, point: Point) -> Option<BondAnchor> {
...
pub fn default_angle_for_anchor(document: &ChemSemaDocument, anchor: &BondAnchor) -> f64 {
