---
name: chemcore-drawing-agent
description: Plan ChemCore-native drawing command scripts using engine queries instead of hand geometry. Use when an agent must create or edit molecules with ChemCore CLI, match GUI bond drawing, attach labels, insert rings/templates, choose label source text and visible reversal, or use plan-bond, plan-template, insert-template, label-query, new, or run.
---
...
chemical edit and ask ChemCore for landing geometry, label behavior, and
