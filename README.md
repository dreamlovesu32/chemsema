...
[![Windows installer](https://img.shields.io/badge/Windows-installer-0078d4)](https://github.com/dreamlovesu32/chemcore/releases/download/v1.0.0-beta.2/Chemcore_1.0.0-beta.2_x64-setup.exe)
...
[v1.0.0-beta.2 release](https://github.com/dreamlovesu32/chemcore/releases/tag/v1.0.0-beta.2).
...
- Release notes: [CHANGELOG.md](./CHANGELOG.md) / [中文](./CHANGELOG.zh-CN.md) / [v1.0.0-beta.2](./docs/releases/v1.0.0-beta.2.md)
