...
pub(super) const ENV_DISABLE_PACKAGED_TRAILING_TRIM: &str =
    "CHEMSEMA_EMF_PACKAGED_TEXT_DISABLE_TRAILING_TRIM";
pub(super) const ENV_DISABLE_PACKAGED_NOFITBLACKBOX: &str =
    "CHEMSEMA_EMF_PACKAGED_TEXT_DISABLE_NOFITBLACKBOX";
pub(super) const ENV_PACKAGED_TEXT_GRIDFIT: &str = "CHEMSEMA_EMF_PACKAGED_TEXT_GRIDFIT";
pub(super) const ENV_PACKAGED_PIXEL_OFFSET_HIGHQUALITY: &str =
    "CHEMSEMA_EMF_PACKAGED_PIXEL_OFFSET_HIGHQUALITY";
pub(super) const ENV_PACKAGED_PIXEL_OFFSET_MODE_VALUE: &str =
    "CHEMSEMA_EMF_PACKAGED_PIXEL_OFFSET_MODE_VALUE";
pub(super) const ENV_PACKAGED_CENTERED_PLAIN_GDI_WIDTH: &str =
    "CHEMSEMA_EMF_PACKAGED_CENTERED_PLAIN_GDI_WIDTH";
pub(super) const ENV_PACKAGED_CENTERED_PLAIN_ZERO_LAYOUT: &str =
    "CHEMSEMA_EMF_PACKAGED_CENTERED_PLAIN_ZERO_LAYOUT";
pub(super) const ENV_PACKAGED_ATTACHED_START_ZERO_LAYOUT: &str =
    "CHEMSEMA_EMF_PACKAGED_ATTACHED_START_ZERO_LAYOUT";
pub(super) const ENV_PACKAGED_ATTACHED_START_TIGHT_RECT: &str =
    "CHEMSEMA_EMF_PACKAGED_ATTACHED_START_TIGHT_RECT";
pub(super) const ENV_PACKAGED_NODE_LABEL_LAYOUT_EXPERIMENT: &str =
    "CHEMSEMA_EMF_PACKAGED_NODE_LABEL_LAYOUT_EXPERIMENT";
pub(super) const ENV_PACKAGED_CENTERED_TEXT_TOP_BIAS_EM: &str =
    "CHEMSEMA_EMF_PACKAGED_CENTERED_TEXT_TOP_BIAS_EM";
pub(super) const ENV_PACKAGED_CENTERED_SCRIPT_EXTRA_TOP_BIAS_EM: &str =
    "CHEMSEMA_EMF_PACKAGED_CENTERED_SCRIPT_EXTRA_TOP_BIAS_EM";
pub(super) const ENV_DEFAULT_MULTILINE_BLACK_LABEL_Y_NUDGE_PX: &str =
    "CHEMSEMA_EMF_DEFAULT_MULTILINE_BLACK_LABEL_Y_NUDGE_PX";
pub(super) const ENV_PACKAGED_SMOOTHING_MODE_VALUE: &str =
    "CHEMSEMA_EMF_PACKAGED_SMOOTHING_MODE_VALUE";
pub(super) const ENV_ATTACHED_LABEL_REPLAY_PHASE_POLICY_EXPERIMENT: &str =
    "CHEMSEMA_EMF_ATTACHED_LABEL_REPLAY_PHASE_POLICY_EXPERIMENT";
pub(super) const ENV_HIDE_DOCUMENT_KNOCKOUT: &str = "CHEMSEMA_EMF_HIDE_DOCUMENT_KNOCKOUT";
pub(super) const ENV_SHOW_INVALID_MARKERS: &str = "CHEMSEMA_EMF_SHOW_INVALID_MARKERS";
pub(super) const ENV_HIDE_DOCUMENT_TEXT: &str = "CHEMSEMA_EMF_HIDE_DOCUMENT_TEXT";
pub(super) const ENV_HIDE_DOCUMENT_BOND: &str = "CHEMSEMA_EMF_HIDE_DOCUMENT_BOND";
pub(super) const ENV_HIDE_DOCUMENT_GRAPHIC: &str = "CHEMSEMA_EMF_HIDE_DOCUMENT_GRAPHIC";
pub(super) const ENV_BOND_PEN_CONVERSION_EXPERIMENT: &str =
    "CHEMSEMA_EMF_BOND_PEN_CONVERSION_EXPERIMENT";
pub(super) const ENV_INCLUDE_OBJECT_IDS: &str = "CHEMSEMA_EMF_INCLUDE_OBJECT_IDS";
pub(super) const ENV_INCLUDE_NODE_IDS: &str = "CHEMSEMA_EMF_INCLUDE_NODE_IDS";
